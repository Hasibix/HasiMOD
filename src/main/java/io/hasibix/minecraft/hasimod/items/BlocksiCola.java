...
public class BlocksiCola extends Item {
	...
	public ItemStack finishUsing(ItemStack itemstack, World world, LivingEntity entity) {
		...
		entity.addStatusEffect(new StatusEffectInstance(StatusEffects.DOLPHINS_GRACE, 24000, 10, (false), (false)));
		entity.addStatusEffect(new StatusEffectInstance(StatusEffects.STRENGTH, 24000, 10, (false), (false)));
