...
public class AfterDrinkingBlocksiCola {
	...
	public static void execute(Map<String, Object> dependencies) {
		...
		if (entity instanceof LivingEntity _entity)
			_entity.addEffect(new MobEffectInstance(MobEffects.DOLPHINS_GRACE, 24000, 10, (false), (false)));
		if (entity instanceof LivingEntity _entity)
			_entity.addEffect(new MobEffectInstance(MobEffects.DAMAGE_BOOST, 24000, 10, (false), (false)));
	}
}
